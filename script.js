...
// ═══════════════════════════════════════════
// DÉMARRAGE (données chargées via <script src="data.js">)
// ═══════════════════════════════════════════
// data.js assigne window.FICHES_DATA avant que ce script s'exécute
FICHES = window.FICHES_DATA || [];
if (FICHES.length === 0) {
  console.error("[App] FICHES_DATA vide — vérifier que data.js est chargé avant script.js dans index.html");
}
console.log("[App] " + FICHES.length + " fiches chargées.");
init();
