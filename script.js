...
{id:2102,cat:"proto",titre:"Protocoles VPN — IPsec, OpenVPN, WireGuard",sub:"Modes, IKE, tunneling",
 schema:`<svg viewBox="0 0 440 250" xmlns="http://www.w3.org/2000/svg"><defs><marker id="vpn-ab" markerWidth="8" markerHeight="8" refX="6" refY="3" orient="auto"><path d="M0,0 L6,3 L0,6 Z" class="sd-arrowhead"/></marker></defs><text class="sd-label" x="110" y="14">Mode Transport (host-to-host)</text><text class="sd-label" x="330" y="14">Mode Tunnel (site-to-site)</text><rect class="sd-box" x="10" y="22" width="200" height="22" rx="3"/><text class="sd-text-small" x="110" y="37">IP src | IP dst | ESP(payload chiffré)</text><rect class="sd-box" x="220" y="22" width="210" height="22" rx="3"/><text class="sd-text-small" x="325" y="37">Nouv.IP | ESP( IP orig | payload )</text><text class="sd-text-small" x="110" y="56">En-tête IP original conservé</text><text class="sd-text-small" x="325" y="56">Paquet entier encapsulé dans nouveau paquet</text><line class="sd-box" x1="220" y1="14" x2="220" y2="80"/><rect class="sd-box" x="10" y="70" width="415" height="18" rx="3"/><text class="sd-text-small" x="218" y="83">IKE Phase 1 : canal sécurisé ISAKMP (auth + chiffrement négociés)</text><rect class="sd-box" x="10" y="91" width="415" height="18" rx="3"/><text class="sd-text-small" x="218" y="104">IKE Phase 2 : SA IPsec (clés de session pour ESP/AH)</text><rect class="sd-box" x="10" y="118" width="415" height="118" rx="6"/><text class="sd-label" x="218" y="133">Comparaison VPN</text><rect class="sd-box-accent" x="20" y="140" width="80" height="16" rx="2"/><text class="sd-text-small" x="60" y="152">IPsec / IKEv2</text><text class="sd-text-small" x="60" y="166">UDP 500/4500</text><text class="sd-text-small" x="60" y="180">AES-256+SHA</text><text class="sd-text-small" x="60" y="194">Natif OS</text><text class="sd-text-small" x="60" y="208">Site-to-site</text><rect class="sd-box" x="160" y="140" width="80" height="16" rx="2"/><text class="sd-text-small" x="200" y="152">OpenVPN</text><text class="sd-text-small" x="200" y="166">UDP/TCP 1194</text><text class="sd-text-small" x="200" y="180">OpenSSL/TLS</text><text class="sd-text-small" x="200" y="194">Configurable</text><text class="sd-text-small" x="200" y="208">Contourne FW</text><rect class="sd-box-accent" x="300" y="140" width="80" height="16" rx="2"/><text class="sd-text-small" x="340" y="152">WireGuard</text><text class="sd-text-small" x="340" y="166">UDP (51820)</text><text class="sd-text-small" x="340" y="180">ChaCha20</text><text class="sd-text-small" x="340" y="194">~4000 lignes</text><text class="sd-text-small" x="340" y="208">Ultra-rapide</text><text class="sd-text-small" x="218" y="228">Split tunneling : seul le trafic LAN passe par le VPN (⚠ fuite possible)</text></svg>`,
...
function execTermCmd(cmd) {
  ...
  // Partial match — la commande tapée commence par le premier mot d'une clé connue
...
function init() {
  ...
  // ── Injection dynamique du bouton Anki dans la mode-row ──
  const modeRow = document.querySelector(".mode-row");
  if (modeRow && !document.getElementById("anki-mode-btn")) {
    const ankiBtn = document.createElement("button");
    ankiBtn.className = "mode-btn";
    ankiBtn.id = "anki-mode-btn";
    ankiBtn.innerHTML = "🧠 Anki";
    ankiBtn.onclick = function() { setMode("anki", this); };
    modeRow.appendChild(ankiBtn);
  }
  ...
  if (!document.getElementById("anki-view")) {
    ...
    `;
    // Insérer avant la fermeture de .app
    appDiv.appendChild(ankiView);
  ...
  // Debounce sur la recherche — évite de recréer 148 cartes à chaque frappe
  const searchBox = document.getElementById("search-box");
  if (searchBox) {
    searchBox.addEventListener("input", debounce(renderCards, 150));
  }
}
...
function setMode(mode, btn) {
  ...
  document.getElementById("anki-view").style.display = mode === "anki" ? "" : "none";
...
function renderStats() {
  ...
  if (seen.size === 0) {
    container.innerHTML = '<div style="text-align:center;padding:3rem 1rem;color:var(--text3);font-size:14px">' +
      '📚 Commence à consulter des fiches pour voir ta progression ici.</div>';
    return;
  }
